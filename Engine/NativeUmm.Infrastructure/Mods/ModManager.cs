...
{
    public static List<ModInfo> List(GameInstallation layout)
    {
    ...
    private static HashSet<string> ReadDisabledIds(GameInstallation layout)
    {
    ...
    public static void Uninstall(GameInstallation layout, string modPath, IOperationLog log, IAppDataPaths appData)
    {
    ...
    public static void Restore(GameInstallation layout, string modPath, IOperationLog log, IAppDataPaths appData)
    {
    ...
    public static void Remove(GameInstallation layout, string modPath, IOperationLog log, IAppDataPaths appData)
    {
    ...
    public static async Task InstallFromUrlAsync(GameInstallation layout, string url, IOperationLog log, IAppDataPaths appData)
    {
        ...
        Install(layout, zipPath, log, appData);
    }

    public static void Install(GameInstallation layout, string zipPath, IOperationLog log, IAppDataPaths appData)
    {
        Directory.CreateDirectory(layout.ModsPath);
    ...
    public static ModInspection Inspect(GameInstallation layout, string zipPath)
    {
        using var zip = OpenAndValidate(zipPath);
        var descriptor = ReadDescriptor(zip);
    ...
    public static void SetEnabled(GameInstallation layout, string modId, bool enabled, IOperationLog log)
    {
        ValidateModId(modId);
